...
namespace ToolBox
{
    ...
    public static class HashIds {
        public const string DefaultAlphabet = "BZ2MYC6DX3QWG7HV4NTJ8KS5PRL9"; //to make Ids look random  *** DO NOT CHANGE!!***
        public const string DefaultSeps = "AEIOU"; //when input array replace the comma with SEPS chars  ***DO NOT CHANGE!!***
        ...
        private static int Unhash(string input, string charset) {
            return input.Select(t => charset.IndexOf(t)).Select((pos, i) => (int)(pos * Math.Pow(charset.Length, input.Length - i - 1))).Sum();
        }
