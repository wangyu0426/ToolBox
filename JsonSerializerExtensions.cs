...
namespace ToolBox {
    public static class JsonSerializerExtensions {
        ...
        public static string SerializeJsonWithJsonNet<T>(this T table) {
        ...
        public static bool FieldContains(this JsonObject m,string field,string value) {
            return !m.Get(field).IsNullOrWhiteSpace() && m.Get(field).Contains(value);
        }
        public static bool FieldNotContains(this JsonObject m, string field, string value) {
            return !m.Get(field).IsNullOrWhiteSpace() && !m.Get(field).Contains(value);
        }
