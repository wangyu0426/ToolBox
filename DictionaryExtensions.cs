...
namespace ToolBox {
    public static class DictionaryExtensions {
        ...
        public static IDictionary<TKey, TVal> TryAddRange<TKey, TVal>(this IDictionary<TKey, TVal> target, IDictionary<TKey, TVal> source) {
            if (target == null) target = new Dictionary<TKey, TVal>();
            source.ForEach(p => { if (target.Get(p.Key) == null) target.Add(p); });
            return target;
        }
        public static IDictionary<TKey, TVal> AddOrUpdate<TKey, TVal>(this IDictionary<TKey, TVal> target, IDictionary<TKey, TVal> source) {
            if (target == null) target = new Dictionary<TKey, TVal>();
            source.ForEach(p => {
